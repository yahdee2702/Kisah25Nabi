package com.yahdi.kisah25nabi.ui
...
import com.yahdi.kisah25nabi.databinding.ActivityMainBinding
import com.yahdi.kisah25nabi.ui.detail.DetailActivity
import com.yahdi.kisah25nabi.utils.OnItemClickCallback
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showError(isError: Throwable?) {
        Toast.makeText(this, isError?.localizedMessage, Toast.LENGTH_SHORT)
            .show()
